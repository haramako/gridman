...
export const COLUMN_TYPE_CONFIG: Record<ColumnType, ColumnTypeConfig> = {
  ...
  'ref[]': { icon: '🔗', defaultWidth: 160, filterOps: OPS_STRING, filterValueWidget: 'text',    defaultWidget: 'tag-list', emptyValue: '', gridReadonly: false, supportsKbdEdit: true,  supportsTypeToEdit: false, hasEnumValues: false, hasRefTable: true,  validationGroup: 'other' },
  json:    { icon: '{}', defaultWidth: 80,  filterOps: OPS_STRING, filterValueWidget: 'text',    defaultWidget: 'json',     emptyValue: '', gridReadonly: true,  supportsKbdEdit: false, supportsTypeToEdit: false, hasEnumValues: false, hasRefTable: false, validationGroup: 'other' },
  text:    { icon: '📝', defaultWidth: 200, filterOps: OPS_STRING, filterValueWidget: 'text',    defaultWidget: 'text',     emptyValue: '', gridReadonly: true,  supportsKbdEdit: false, supportsTypeToEdit: false, hasEnumValues: false, hasRefTable: false, validationGroup: 'string' },
  date:    { icon: '📅', defaultWidth: 120, filterOps: OPS_STRING, filterValueWidget: 'text',    defaultWidget: 'text',     emptyValue: '', gridReadonly: false, supportsKbdEdit: true,  supportsTypeToEdit: true,  hasEnumValues: false, hasRefTable: false, validationGroup: 'other' },
}
